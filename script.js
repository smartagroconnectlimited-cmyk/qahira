...
const menu = {
  ...
  desserts: [
    ...
    { name: "Om Ali", desc: "Warm Egyptian bread pudding with nuts, raisins and clotted cream.", price: "KSh 400", img: "om-ali.jpg" },
    { name: "Chocolate Lava Cake", desc: "Warm chocolate cake with a molten centre, served with vanilla ice cream.", price: "KSh 500", img: "chocolate-lava-cake.jpg" },
  ],
};
